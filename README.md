...
**Note pour le glisser-déposer des images :** Placez chaque fichier image (`1.png`, `2.png`, `3.png`, `4.png`, `6.png`, `7.png`, `8.png`, `9.png`, `10.png`, `11.png`, `12.png`, `13.png`, `14.png`) dans le dossier `./images/`. La numérotation correspond exactement à l'ordre original, vous pouvez donc les glisser un par un.
